...
VM storage migration feature changes status from Technical Preview status to being generally available.
...
.UI crashes during a namespace search in the migration plan wizard
