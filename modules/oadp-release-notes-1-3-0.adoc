...
It might take up to 40 minutes to restore CephFS PVs if Data Mover is used to back up and restore them. link:https://issues.redhat.com/browse/OADP-2029[OADP-2029]
